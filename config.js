...
window.CONFIG = {
  ...
  // Paste the Apps Script web-app /exec URL here after you deploy Code.gs.
  // Leave it empty ("") to keep the dashboard read-only (buttons stay hidden).
  ...
  // Must match SECRET_TOKEN in Code.gs. Use a long random string.
